...
<body>
	<div align="center">	
		...
		<table class="login" cellpadding="0" cellspacing="0" border="0">
            ...
            <tr>
            	<td style="padding-left:47px;" colspan="2">
            		<div id="errors">
            		The Username and/or Password you have entered does not match an existing account.  Please try again
            		or contact your system administration for assistance.
            		</div></br>
            	</td>
            </tr>
            <tr>
